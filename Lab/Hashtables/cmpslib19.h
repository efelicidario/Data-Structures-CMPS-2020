...
/* get info about your variables to cout or write to logfile */

#define GET_VARIABLE_NAME(Variable) (#Variable)

#define VarInfo(x) VAR_INFO(#x,x)

template <class T>
inline string VAR_INFO(const char * name,T & val)
{
ostringstream tmp;
tmp << std::left << "name: " <<setw(20) << name << "   type: " << setw(30) <<  GetClassName(val) << "size: " << sizeof(T) << "   address: " << ((void*)& val) << "   value: " << val << endl;
return tmp.str();
}
